      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-gradient">Kōen</span>
            </div>
            <p className="text-foreground/60">
              Reputation-based lending protocol built on Bitcoin and Stacks.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-foreground/60">
              ...
              <li><a href="#" className="hover:text-accent transition-colors">Reputation Tiers</a></li>
          ...
          {/* Developers */}
          <div>
            <h3 className="font-bold text-foreground mb-4">Developers</h3>
            <ul className="space-y-2 text-foreground/60">
              ...
              <li><a href="#" className="hover:text-accent transition-colors">Audits</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-foreground/60 text-sm">
            © 2024 Kōen Protocol. All rights reserved.
          </p>
