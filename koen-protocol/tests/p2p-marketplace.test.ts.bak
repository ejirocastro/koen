...
describe("P2P Marketplace - Lending Offers", () => {
  ...
  it("should prevent canceling matched offer", () => {
    // Setup borrower
    simnet.callPublicFn("sbtc-token", "faucet", [], borrower);
...
describe("P2P Marketplace - Reputation Bonus System", () => {
  ...
  it("should calculate effective collateral ratio correctly for each tier", () => {
    ...
    // Test Bronze (0% bonus)
    simnet.callPublicFn("sbtc-token", "faucet", [], bronzeUser);
    ...
    simnet.callPublicFn("sbtc-token", "faucet", [], silverUser);
    ...
    // Test Gold (20% bonus)
    simnet.callPublicFn("sbtc-token", "faucet", [], goldUser);
